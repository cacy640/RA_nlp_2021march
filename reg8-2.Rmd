...
*regression model*
log(1+y)~log(1+x)  
y=log(1+sentiment), x=log(1+covid_variable)  
...
# data processing
```{r, message=F, error=F}
#new_df3 <- read_csv("processed_data/combined_df3_log.csv")
#new_df4 <- read_csv("processed_data/combined_df4_log.csv")

new_df3 <- read_csv("processed_data/rescaled2_df3_log.csv")
#new_df3 <- new_df3[-c(1:36),]
#new_df3 <- new_df3[-c(1:66),]
new_df4 <- read_csv("processed_data/rescaled2_df4_log.csv")
